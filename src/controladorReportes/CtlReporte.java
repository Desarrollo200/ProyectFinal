...
public class CtlReporte {
    ...
    public void generarReporteCiudadano() {
        Connection cn;
        cn = conexion.conectarReporte();
        ...
        String path = "/Users/nicolasgarcia/Documents/GitHub/ProyectFina/src/Reportes/ReporteCiudadano.jasper";
        //String path = "src\\Reportes\\ReporteUsuarios2.jasper";
        //String path = "C:\\Users\\DAGA\\JaspersoftWorkspace\\MyReports\\ReporteUsuarios2.jasper";
        try {
            reporte = (JasperReport) JRLoader.loadObjectFromFile(path); //Cargo el reporte al objeto
    ...
    public void generarReporteCDA() {
        ...
        String path = "/Users/nicolasgarcia/Documents/GitHub/ProyectFina/src/Reportes/ReporteCDA.jasper";
        //String path = "src\\Reportes\\ReporteUsuarios2.jasper";
        //String path = "C:\\Users\\DAGA\\JaspersoftWorkspace\\MyReports\\ReporteUsuarios2.jasper";
        try {
            reporte = (JasperReport) JRLoader.loadObjectFromFile(path); //Cargo el reporte al objeto
    ...
    public void generarReporteComparendo() {
        Connection cn;
        cn = conexion.conectarReporte();
        ...
        String path = "/Users/nicolasgarcia/Documents/GitHub/ProyectFina/src/Reportes/ReporteComparendo.jasper";
        //String path = "src\\Reportes\\ReporteUsuarios2.jasper";
        //String path = "C:\\Users\\DAGA\\JaspersoftWorkspace\\MyReports\\ReporteUsuarios2.jasper";
        try {
            reporte = (JasperReport) JRLoader.loadObjectFromFile(path); //Cargo el reporte al objeto
    ...
    public void generarReporteLicencias() {
        Connection cn;
        cn = conexion.conectarReporte();
        ...
        String path = "/Users/nicolasgarcia/Documents/GitHub/ProyectFina/src/Reportes/ReporteLicencias.jasper";
        //String path = "src\\Reportes\\ReporteUsuarios2.jasper";
        //String path = "C:\\Users\\DAGA\\JaspersoftWorkspace\\MyReports\\ReporteUsuarios2.jasper";
        try {
            reporte = (JasperReport) JRLoader.loadObjectFromFile(path); //Cargo el reporte al objeto
    ...
    public void generarReporteAseguradora() {
        Connection cn;
        cn = conexion.conectarReporte();
        ...
        String path = "/Users/nicolasgarcia/Documents/GitHub/ProyectFina/src/Reportes/ReportesAseguradora.jasper";
        //String path = "src\\Reportes\\ReporteUsuarios2.jasper";
        //String path = "C:\\Users\\DAGA\\JaspersoftWorkspace\\MyReports\\ReporteUsuarios2.jasper";
        try {
            reporte = (JasperReport) JRLoader.loadObjectFromFile(path); //Cargo el reporte al objeto
